package com.github.itxiaox.menu.dropdownlist;
...
public class DropListEditText {
	...
	public void showpopwindow(Context context,final EditText editText,final List<String> numberList){
...
//		}
		...
		popwindow = new PopupWindow(lv_list, editText.getWidth() - 4, param.WRAP_CONTENT);
		...
		// 显示在输入框的左下角位置
		popwindow.showAsDropDown(editText, 2, -4);
