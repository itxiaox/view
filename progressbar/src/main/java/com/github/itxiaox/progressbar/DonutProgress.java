package com.github.itxiaox.progressbar;
...
public class DonutProgress extends View {
    ...
    private float startAngel = -90;//从多少角度开始绘制已经完成弧段
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(finishedOuterRect, startAngel, getProgressAngle(), false, finishedPaint);
        canvas.drawArc(unfinishedOuterRect, startAngel+getProgressAngle(), 360 - getProgressAngle(), false, unfinishedPaint);
