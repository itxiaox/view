...
package com.itxiaox.xview.gridview.stickygridheaders;
...
public class StickyGridHeadersGridView extends GridView implements OnScrollListener,
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        for (int i = 0; i < headerPositions.size(); i++) {
            ...
            int heightMeasureSpec = MeasureSpec.makeMeasureSpec(MeasureSpec.UNSPECIFIED, MeasureSpec.UNSPECIFIED);

            header.measure(MeasureSpec.makeMeasureSpec(MeasureSpec.UNSPECIFIED,
                    MeasureSpec.UNSPECIFIED),MeasureSpec.makeMeasureSpec(MeasureSpec.UNSPECIFIED,
        ...
        if (mStickiedHeader.getWidth() != wantedWidth) {
            ...
            mStickiedHeader.measure(MeasureSpec.makeMeasureSpec(MeasureSpec.UNSPECIFIED,MeasureSpec.UNSPECIFIED),MeasureSpec.makeMeasureSpec(MeasureSpec.UNSPECIFIED,MeasureSpec.UNSPECIFIED));
            mStickiedHeader.measure(widthMeasureSpec, heightMeasureSpec);
            if (mHeadersIgnorePadding) {
