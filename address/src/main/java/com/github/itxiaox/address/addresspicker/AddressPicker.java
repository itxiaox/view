package com.github.itxiaox.address.addresspicker;
...
public class AddressPicker implements OnWheelChangedListener{
	...
	public void selectAddressDialog(Context context,TextView address) {
		...
		dialog_photo = new Dialog(context, R.style.Dialog_Fullscreen);
		...
		window.setWindowAnimations(R.style.picker); // 添加动画
