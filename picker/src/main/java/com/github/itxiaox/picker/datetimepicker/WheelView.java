...
//			0x00AAAAAA, 0x00AAAAAA };
	...
	//modified by xx 2016-01-06
	private int[] SHADOWS_COLORS = new int[] { 0xefE9E9E9,
			0xcfE9E9E9, 0x3fE9E9E9 };
//	private int[] SHADOWS_COLORS = new int[] { Color.RED,
//			Color.BLUE, Color.GREEN }; //渐变颜色
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.province_line_border));//选中线的颜色
		// 设置线宽
