package com.github.itxiaox.loadingdialog;
...
import com.github.itxiaox.dialog.R;
...
public class LoadingDialog implements FinishDrawListener {
    ...
    public LoadingDialog(Context context) {
        ...
        mLoadingDialog.setContentView(layout, new LinearLayout.LayoutParams(
                ...
                LinearLayout.LayoutParams.MATCH_PARENT));
        mLoadingDialog.setOnDismissListener(dialog -> mContext = null);
        initStyle();
     ...
     */
    public LoadingDialog setDrawColor( int color) {
