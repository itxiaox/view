...
import com.itxiaox.xview.gridview.stickygridheaders.StickyGridHeadersSimpleAdapter;
...
public class StickyGridAdapter extends BaseAdapter implements
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.xx_stickygridview_item, parent, false);
		...
		if (bitmap != null) {
			...
			mViewHolder.mImageView
					.setImageResource(R.drawable.xx_friends_sends_pictures_no);
		}
	...
	public View getHeaderView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.xx_stickygridview_header, parent, false);
